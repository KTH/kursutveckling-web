const mockRawAnalysisData = [
    {
      ...
      isPublished: true,
      commentChange: '',
      commentExam: 'Examinator beslutar, baserat på rekommendation från KTH:s ' +
    ...
    },
    {
      ...
      ugKeys: [
        "SF1624.examiner",
        "SF1624.20182.7.courseresponsible"
      ],
      pmFileName: '',
    ...
    },
    {
      ...
      ugKeys: [
        "SF1624.examiner",
        "SF1624.20192.6.courseresponsible",
        "SF1624.20192.5.courseresponsible"
      ],
      pmFileName: '',
      analysisFileName: '',
      roundIdList: '5,6',
      ...
      analysisName: 'CINTE1 ( Startdatum 2019-10-28, Svenska ) , ' +
        ' CITEH1 ( Startdatum 2019-10-28, Svenska )',
      __v: 0
    },
    {
      ...
      commentExam: 'Based on recommendation from KTH’s coordinator for disabilities, ' +
      ...
      analysisName: 'TCOMK1 ( Start date  17/01/2017, English ) , ' +
        ' CINTE1 ( Start date  17/01/2017, Swedish )',
      __v: 0
    },
    {
      _id: 'SF1624HT2019_8',
      ...
      ugKeys: [
        "SF1624.examiner",
        "SF1624.20192.8.courseresponsible"
      ],
      pmFileName: '',
...
module.exports = mockRawAnalysisData
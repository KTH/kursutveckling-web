module.exports = {
  ...
  tableHeaders: {
    ...
    alt_header_main_publish_new: 'Go to the admin page to Publish new course analysis with kursdata for year ',
    alt_header_main_edit: 'Go to the admin page to Edit published course analysis and course data. Course rounds:',
    ...
    table_headers_with_popup: {
      ...
      examShortAndLongStrArr: {header: 'Examination', popoverText: 'Form of examinataion for the course offering in the format: examination module, credits, grading scale. View details about Examination on the page Before choosing course.'},
      alterationText: {header: 'Changes of the course before this course offering', popoverText: 'Summarized changes made to the course before this particular course offering. The purpose of publishing changes made to the course is to show the improvements of the course over time. All changes documented to the course offerings gives an overview of the improvement steps of the course.'},
